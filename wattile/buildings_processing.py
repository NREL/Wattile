...
def roll_predictors_target(data, configs):
    ...
    # setting configuration parameters
    window_width_source = (
        configs["data_processing"]["input_output_window"]["window_width_source"]
        + configs["data_processing"]["resample_interval"]
    )
    window_width_target = (
        configs["data_processing"]["input_output_window"]["window_width_target"]
        + configs["data_processing"]["resample_interval"]
    )
    resample_interval = configs["data_processing"]["resample_interval"]
    target_var = configs["data_input"]["target_var"]
